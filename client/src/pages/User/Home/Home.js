        ...
        <nav className="navbar">
          ...
          <div className="menu">
            <ul>
              ...
              <li>
                <a href="#" onClick={() => handleToggleSubMenu("categories")}>
                  Categories{" "}
                </a>{" "}
              ...
              <li>
                <a href="#" onClick={() => handleToggleSubMenu("about")}>
                  About Us{" "}
                </a>{" "}
                {activeSubMenu === "about" && (
                  <div className="submenu">
                    <a href="#"> Our Story </a> <a href="#"> Our Team </a>{" "}
                    <a href="#"> Testimonials </a> <a href="#"> Career </a>{" "}
                  </div>
                )}{" "}
              </li>{" "}
              <li>
                <a href="#" onClick={() => handleToggleSubMenu("support")}>
                  Support{" "}
                </a>{" "}
                {activeSubMenu === "support" && (
                  <div className="submenu">
                    <a href="/user/contact-us"> Contact Us </a>{" "}
                    <a href="#"> FAQ </a> <a href="#"> Shipping Information </a>{" "}
                  </div>
                )}{" "}
              </li>{" "}
              <li>
                <a href="#" onClick={() => handleToggleSubMenu("followUs")}>
                  Follow Us{" "}
                </a>{" "}
