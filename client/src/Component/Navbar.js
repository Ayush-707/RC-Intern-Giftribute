    ...
    return ( <
        ...
        div className = "flex" > { " " } {
            options && ( <
                ...
                <
                a className = "text-white hover:underline text-lg"
                href = "/" >
                Home { " " } <
                /a>{" "} <
                div className = "relative inline-block" >
                <
                a className = { `text-white hover:underline text-lg cursor-pointer ${
                      menuStates.isGiftsMenuOpen ? "underline" : ""
                    }` }
                href = "#"
                onClick = {
                    () => toggleMenu("isGiftsMenuOpen") } >
                Gifts { " " } <
                /a>{" "} {
                ...
                /div>{" "} <
                a className = "text-white text-2xl px-1"
                href = "/my-cart"
                title = "Cart" >
                <
